        ...
        <div className="col">
          <div className="card">
            ...
            <div className="card-body pt-0">
              <div className="d-flex align-items-end gap-2 justify-content-between">
                <div className="text-end flex-shrink-0">
                  <div id="new-users-chart" data-colors="#f9c851,#F6F7FB" />
                </div>
                <div className="text-end">
                ...
                <div className="row mt-3">
                  <div className="col">
                    <div className="d-flex justify-content-between align-items-center p-1">
                      ...
                      <span className="fw-semibold text-muted float-end">
                        <i className="ri-arrow-down-s-fill text-danger" /> 965
                      </span>
                    </div>
                    <div className="d-flex justify-content-between align-items-center p-1">
                      <div>
                  ...
                  <div className="col">
                    <div className="d-flex justify-content-between align-items-center p-1">
                      ...
                      <span className="fw-semibold text-muted float-end">
                        <i className="ri-arrow-up-s-fill text-success" /> 102
                      </span>
                    </div>
                    <div className="d-flex justify-content-between align-items-center p-1">
                      <div>
                      ...
                      <span className="fw-semibold text-muted float-end">
                        <i className="ri-arrow-down-s-fill text-danger" /> 96
                      </span>
                    </div>
                  </div>
                </div>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <br />
                            <h5 className="fs-14 mt-1">TechNova - Germany</h5>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <span className="text-muted fs-12">Home Decor</span>
                            <br />
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <span className="text-muted fs-12">Technology</span>
                            <br />
                            <h5 className="fs-14 mt-1">InnovTech - Japan</h5>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <span className="text-muted fs-12">Automotive</span>
                            <br />
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="ps-0">
                        ...
                        <span className="text-muted fs-12">15 April 2024</span>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td className="ps-0">
                        ...
                        <span className="text-muted fs-12">10 April 2024</span>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td className="ps-0">
                        ...
                        <span className="text-muted fs-12">05 April 2024</span>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td className="ps-0">
                        ...
                        <span className="text-muted fs-12">02 April 2024</span>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td className="ps-0">
                        ...
                        <span className="text-muted fs-12">29 March 2024</span>
                      </td>
                      <td>
